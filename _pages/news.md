...
<div style="border: 2px solid #333; padding: 15px; margin-bottom: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
  <h2 style="background-color: #5bc0de; padding: 10px; border-radius: 5px; text-align: center;">2026</h2>
  <ul style="list-style: none; padding-left: 0;">
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <em>Dissecting the gender divide: authorship and acknowledgment in scientific publications</em> (Keigo Kusumegi, Daniel, and Yukie Sano) is published in <a href="https://doi.org/10.1007/s11192-026-05712-z">Scientometrics</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            August 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Daniel joined the panel <em>The Future Infrastructure of the Scientific Ecosystem</em> (with Jessica Hullman and Aaron Clauset, moderated by Misha Teplitskiy) at the <a href="https://www.icssi.org/">International Conference on the Science of Science and Innovation (ICSSI 2026)</a>, held in Boulder, Colorado, June 29 – July 1
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            June 30, 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Strong lab presence at <a href="https://www.icssi.org/">ICSSI 2026</a> in Boulder: Almene gave the lightning talk <em>How Willing Are LLMs to Commit Scientific Fraud? A Study of 17 Commercial and Open Models</em>; Christopher presented <em>Quantifying and Understanding Global Disparities in Biomedical Research</em>; Carolina presented <em>Parental Occupation and Socioeconomic Origins in Academic Faculty</em> (with Katie Spoon, Dan Larremore, Daniel, and Aaron Clauset) and a poster on LLM-based gender classification; and Pawin presented the poster <em>Driving Science with Multi-Agents and Reinforcement Learning: Are LLMs Effective for Automated Peer Review?</em>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            June 29 – July 1, 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <em>Beyond a number game: Flat team structures improve inclusion and performance in diverse scientific teams</em> (Huimin Xu et al., with Daniel) is published in <a href="https://doi.org/10.1002/asi.70083">JASIST</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            June 24, 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Almene and Pawin were selected to attend the <a href="https://mlss.cc/">Machine Learning Summer School (MLSS) 2026</a> at Columbia University in New York City
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            June 15-26, 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            New preprint by Almene, with Maria Pacheco and Daniel: <a href="https://arxiv.org/abs/2605.29468">SciIntBench: Measuring LLM Compliance with Research Integrity Norms Under Adversarial Framing</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            May 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            At the <a href="https://wcri2026.org/">9th World Conference on Research Integrity (WCRI 2026)</a> in Vancouver, Canada, Daniel gave the talk <em>Estimating the predictability of questionable journals: signals and interpretation</em> and Pawin presented the poster <em>Identifying Potential Falsified Research Outcomes from Partial Table Duplications</em>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            May 3-8, 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            New preprint by Pawin and Daniel: <a href="https://arxiv.org/abs/2604.00248">REM-CTX: Automated Peer Review via Reinforcement Learning with Auxiliary Context</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            March 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            NBER working paper <a href="https://doi.org/10.3386/w34856">Government Funding and the Direction of Academic Energy Research</a> (David Popp, Myriam Gregoire-Zawilski, Lizhen Liang, and Daniel), from our Sloan Foundation project, is out
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            February 2026
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <em>Widespread reference missingness disparities in open scholarly metadata</em> (Huaxia Zhou, Lizhen Liang, and Daniel) is published in <a href="https://doi.org/10.1162/qss.a.400">Quantitative Science Studies</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            2026
        </div>
...
<!-- 2025 News -->
<div style="border: 2px solid #333; padding: 15px; margin-bottom: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
  <h2 style="background-color: #5bc0de; padding: 10px; border-radius: 5px; text-align: center;">2025</h2>
  <ul style="list-style: none; padding-left: 0;">
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Daniel delivered the keynote at the <a href="https://ai4scisci.github.io/2025/">2nd International Workshop on Artificial Intelligence and the Science of Science (AI4SciSci 2025)</a> at JCDL 2025, presenting our work on estimating the predictability of questionable open-access journals
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            December 15, 2025
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Carolina passed her preliminary exam. Congrats Carolina!
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            September 2025
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <em>Estimating the predictability of questionable open-access journals</em> (Han Zhuang, Lizhen Liang, and Daniel) is published in <a href="https://doi.org/10.1126/sciadv.adt2792">Science Advances</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            August 29, 2025
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Daniel participated in the inaugural National Conference on Research Integrity (NCRI 2025) in Chicago, IL
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            May 2025
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Carolina presented her work at the 10th <a href="https://atlconf.org/">Atlanta Conference on Science and Innovation Policy (ATLC 2025)</a> at Georgia Tech
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            May 2025
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            New preprint by Pawin and Daniel: <a href="https://arxiv.org/abs/2505.11718">REMOR: Automated Peer Review Generation with LLM Reasoning and Multi-Objective Reinforcement Learning</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            May 2025
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <em>Predicting the longevity of resources shared in scientific publications</em> is published in <a href="https://doi.org/10.1057/s41599-025-04716-z">Humanities and Social Sciences Communications</a>, and <em>Paraphrase Identification with Deep Learning: A Review of Datasets and Methods</em> (Chao Zhou, Cheng Qiu, Lizhen Liang, and Daniel) in <a href="https://doi.org/10.1109/ACCESS.2025.3556899">IEEE Access</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            2025
        </div>
...
<div style="border: 2px solid #333; padding: 15px; margin-bottom: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
  ...
  <ul style="list-style: none; padding-left: 0;">
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <a href="https://openreview.net/forum?id=frvkE8rCfX">MAMORX: Multi-agent Multi-modal Scientific Review Generation with External Knowledge</a> (Pawin Taechoyotin, Guanchao Wang, Tong Zeng, Bradley Sides, and Daniel) was accepted at the NeurIPS 2024 Workshop on Foundation Models for Science
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            December 2024
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <a href="https://ceur-ws.org/Vol-3815/paper1.pdf">Comparative Explanations for Recommendation: Research Directions</a> (Meysam Varasteh, Elizabeth McKinnie, Amanda Aird, Daniel, and Robin Burke) appeared at the IntRS workshop at RecSys 2024
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            October 2024
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <em>Incorporating costs and benefits to the evaluation of uncertain research results: applications to cancer research funding</em> (Han Zhuang and Daniel) is published in <a href="https://doi.org/10.1162/qss_a_00332">Quantitative Science Studies</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            September 2024
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            Welcome to our new Ph.D. students Pawin Taechoyotin, Almene De Meran Meguimtsop, and Christopher Ebuka Ojukwu!
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            Fall 2024
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <a href="https://aclanthology.org/2024.sdp-1.15/">MISTI: Metadata-Informed Scientific Text and Image Representation through Contrastive Learning</a> (Pawin and Daniel) appeared at the 4th Workshop on Scholarly Document Processing (SDP 2024) at ACL 2024
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            August 2024
        </div>
    ...
    <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        <div style="flex: 1;">
            <em>Science Needs You: Mobilizing for Diversity in Award Recognition</em> (Elizabeth Novoa-Monsalve, David Patterson, Stephanie Ludi, and Daniel) is published in <a href="https://dl.acm.org/doi/10.1145/3651150">Communications of the ACM</a>
        </div>
        <div style="flex: 0 0 150px; text-align: right; color: #555; font-style: italic;">
            August 2024
        </div>
