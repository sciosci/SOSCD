...
<main id="main" class="interior-main wrap research-overview">
  ...
  <section class="research-close"><h2>Supporting the work</h2><p>See the <a href="{{ '/funding/' | relative_url }}">grants and projects supporting our research</a>, explore <a href="{{ '/openings/' | relative_url }}">information about joining the lab</a>, or learn how to <a href="{{ '/support/' | relative_url }}">support our mission</a>.</p></section>
</main>
